...
class ReyashibotStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        deployment_group_role = iam.Role(self, "TeaGlossarySearchDeploymentGroupRole", assumed_by=iam.ServicePrincipal("codedeploy.amazonaws.com"))
        deployment_group_role.grant(tea_glossary_search_deploy_post_hook, "lambda:InvokeFunction")
        deployment_group_role.add_to_policy(iam.PolicyStatement(resources=['*'], actions=['lambda:InvokeFunction']))
